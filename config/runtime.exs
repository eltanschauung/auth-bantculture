...
config :auth_bantculture_com,
  passwords_path: System.get_env("PASSWORDS_PATH") || Path.expand("../var/passwords.log", __DIR__),
  access_path: System.get_env("ACCESS_PATH") || Path.expand("../var/access.conf", __DIR__),
  access_denied_log_path: System.get_env("ACCESS_DENIED_LOG_PATH") || Path.expand("../var/access_denied.log", __DIR__),
